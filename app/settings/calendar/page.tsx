...
export default function CalendarSettings(){
  ...
  const url = state.contractorProfile.calendarICS || 'https://example.com/airlink.ics'
  return (
    <section className="section">
      <h1 className="text-xl font-semibold text-ink mb-3">Calendar</h1>
      <div className="card p-4 space-y-3">
        <div className="text-sm">Subscribe to your AirLink availability feed (read-only):</div>
